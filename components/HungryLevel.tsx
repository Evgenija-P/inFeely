	...
	return (
		<BaseWrapper style={{}}>
			<View style={{ gap: 8 }}>
				...
				>
					I feel a little empty. <br />
					It’s not urgent, but I could eat something.
				</ThemedText>
			</View>
			<View style={{ gap: 8 }}>
				<ThemedText
				...
				<MultiSlider
					...
					selectedStyle={{
						backgroundColor: valuePicker(sliderValue[0]) ?? Colors.light.ellipse_lite,
						height: 16,
						borderRadius: 16
					}}
					unselectedStyle={{
					...
					markerStyle={{
						...
						borderRadius: 16,
						borderWidth: 2,
						borderColor: valuePicker(sliderValue[0]) ?? Colors.light.ellipse_lite,
